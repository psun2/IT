...
public class Person_Teacher extends Person_Person{
...
//	변수를 초기화 할 수 있는 생성자 함수를 만들 수 있습니다.
	public Person_Teacher(String name, int age, int height, int weight, String teacherID, int monthSalary, int workedYear) {
